 ...
 * Copyright (c) 2008-2013 Philip Hutchison
 * MIT License
 */

var pipwerks = {};
pipwerks.SCORM = {
    version: "1.1.20130301",
...
pipwerks.SCORM.API.find = function(win) {
    ...
    if (scorm.version) {
        switch (scorm.version) {
            case "2004":
                if (win.API_1484_11) {
                    ...
                    trace(traceMsgPrefix + ": SCORM 2004 API not found.");
                }
                break;
            case "1.2":
                if (win.API) {
                    ...
                    trace(traceMsgPrefix + ": SCORM 1.2 API not found.");
                }
                break;
        }
    } else {
        if (win.API_1484_11) {
            ...
            trace(traceMsgPrefix + ": A SCORM API was not found.");
        }
    }
    
    if (API) {
        trace(traceMsgPrefix + ": SCORM " + scorm.version + " API found.");
        trace("API: " + API);
    }
...
pipwerks.SCORM.API.get = function() {
    ...
    if (!scorm.API.isFound) {
        ...
        if (API) {
            ...
            errorCode = 1;
            trace(traceMsgPrefix + ": " + errorCode);
        }
    } else {
        API = scorm.API.handle;
    }
...
pipwerks.SCORM.API.getHandle = function() {
    ...
    if (!API) {
        if (pipwerks.SCORM.debug.isActive) {
            pipwerks.UTILS.trace("SCORM.API.getHandle failed: API is null");
        }
    }
    return API;
};
...
pipwerks.SCORM.debug.getCode = function() {
    ...
    if (API) {
        ...
        pipwerks.UTILS.trace("SCORM.debug.getCode failed: API is null.");
    }
...
pipwerks.SCORM.debug.getInfo = function(errorCode) {
    ...
    if (API) {
        ...
        pipwerks.UTILS.trace("SCORM.debug.getInfo failed: API is null.");
    }
...
pipwerks.SCORM.debug.getDiagnosticInfo = function(errorCode) {
    ...
    if (API) {
        ...
        pipwerks.UTILS.trace("SCORM.debug.getDiagnosticInfo failed: API is null.");
    }
